...
if page == pages[9]:
    st.write(
        """ Disclaimer: Betting on tennis matches can pose significant risks and may result in financial loss. It is important to recognize that gambling carries inherent dangers and should be approached with caution. Tennis, like any sport, can be unpredictable, and outcomes may not always align with expectations. Engaging in betting activities should be done responsibly, with full awareness of the potential consequences. Individuals should only wager what they can afford to lose and should refrain from viewing gambling as a guaranteed source of income. Seek appropriate guidance if you believe you may have a gambling problem. Remember, the decision to participate in betting activities ultimately rests with the individual, and any losses incurred are solely their responsibility. """)
